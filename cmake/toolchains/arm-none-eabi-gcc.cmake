...
set(CMAKE_C_COMPILER   "${triple}gcc${surfix}")
set(CMAKE_CXX_COMPILER "${triple}g++${surfix}")

# Some are autodiscovered, some are not, better make them explicit.
set(CMAKE_ADDR2LINE "${triple}addr2line${surfix}")
set(CMAKE_AR "${triple}ar${surfix}")

set(CMAKE_ASM_COMPILER "${triple}gcc${surfix}")
set(CMAKE_ASM_COMPILER_AR "${triple}gcc-ar${surfix}")
set(CMAKE_ASM_COMPILER_RANLIB "${triple}gcc-ranlib${surfix}")

set(CMAKE_C_COMPILER_AR "${triple}gcc-ar${surfix}")
set(CMAKE_C_COMPILER_RANLIB "${triple}gcc-ranlib${surfix}")

set(CMAKE_CXX_COMPILER_AR "${triple}gcc-ar${surfix}")
set(CMAKE_CXX_COMPILER_RANLIB "${triple}gcc-ranlib${surfix}")

set(CMAKE_LINKER "${triple}ld${surfix}")

set(CMAKE_NM "${triple}nm${surfix}")
set(CMAKE_OBJCOPY "${triple}objcopy${surfix}")
set(CMAKE_OBJDUMP "${triple}objdump${surfix}")
set(CMAKE_RANLIB "${triple}ranlib${surfix}")
set(CMAKE_READELF "${triple}readelf${surfix}")

# Must be explicit, not set by CMake.
set(CMAKE_SIZE "${triple}size${surfix}")

set(CMAKE_STRIP "${triple}strip${surfix}")
